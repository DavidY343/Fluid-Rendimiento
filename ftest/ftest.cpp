...
TEST_F(TestFuncionales, testSmall1) {
  ...
  std::filesystem::path ruta_ejecutable =
      std::filesystem::current_path();               // Ruta del directorio actual
  ...
  std::string const comando =
      ruta_ejecutable.string() + " " + std::to_string(1) + " " + ruta_entrada + " " + ruta_salida;
...
TEST_F(TestFuncionales, testSmall2) {
  ...
  // Construir el comando para ejecutar el programa principal con rutas absolutas
  std::string const comando =
      ruta_ejecutable.string() + " " + std::to_string(2) + " " + ruta_entrada + " " + ruta_salida;
...
TEST_F(TestFuncionales, testSmall3) {
  ...
  // Construir el comando para ejecutar el programa principal con rutas absolutas
  std::string const comando =
      ruta_ejecutable.string() + " " + std::to_string(3) + " " + ruta_entrada + " " + ruta_salida;
...
TEST_F(TestFuncionales, testSmall4) {
  ...
  // Construir el comando para ejecutar el programa principal con rutas absolutas
  std::string const comando =
      ruta_ejecutable.string() + " " + std::to_string(4) + " " + ruta_entrada + " " + ruta_salida;
...
TEST_F(TestFuncionales, testSmall5) {
  ...
  // Construir el comando para ejecutar el programa principal con rutas absolutas
  std::string const comando =
      ruta_ejecutable.string() + " " + std::to_string(5) + " " + ruta_entrada + " " + ruta_salida;
